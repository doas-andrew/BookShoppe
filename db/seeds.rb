...
scott = User.create(first_name: 'Scott', last_name: 'Toney', username: 'AScottToney', email: 'scott@test.com', password: '123', phone_number: '5556782222', address: 'Midtown Atlanta')
