...
#...
User.create(first_name: 'Andrew', last_name: 'Allen', username: 'ASAllen67', email: '2@2.w', password: '123', phone_number: '1234567890', address: '900 Parsons Drive').user_books.create(book: Book.second)
