...
User.create(first_name: 'Jaehyun', last_name: 'Park', username: 'Jae', email: 'jae@test.com', password: '123', phone_number: '5551234567', address: '567 Roundtree Park').user_books << [UserBook.create(book: Book.third), UserBook.create(book: Book.third), UserBook.create(book: Book.last)]
scott = User.create(first_name: 'Scott', last_name: 'Toney', username: 'Scott', email: 'scott@test.com', password: '123', phone_number: '5556782222', address: 'Midtown Atlanta')
